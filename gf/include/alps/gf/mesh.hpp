  ...
  namespace gf {
    ...
    public:
      ...
      void load(alps::hdf5::archive& ar, const std::string& path)
      {
        ...
        positivity_=frequency_positivity_type(posonly);
        beta_=beta;
        nfreq_=nfr;
        check_range();
        compute_points();
      ...
      void check_range(){
        ...
        if(positivity_!=POSITIVE_ONLY) throw std::invalid_argument("positivity should be POSITIVE_ONLY or POSITIVE_NEGATIVE");
      }
      void compute_points(){
