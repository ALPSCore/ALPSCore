...
namespace alps {
	...
	template<typename U, typename T> inline void convert(U const * arg1, U const * arg2, T * arg3) {
		std::copy(arg1, arg2, arg3);
	}

	#define ALPS_HDF5_CONVERT_STRING_POINTER(T)                                                                                                \
		template<> inline void convert<std::string, T >(std::string const *, std::string const *, T *) {                                       \
			ALPS_NGS_THROW_RUNTIME_ERROR("Not implemented");                                                                                   \
		}                                                                                                                                      \
		template<> inline void convert<T, std::string>(T const *, T const *, std::string *) {                                                  \
			ALPS_NGS_THROW_RUNTIME_ERROR("Not implemented");                                                                                   \
		}
	...
	ALPS_HDF5_CONVERT_STRING_POINTER(unsigned int)
