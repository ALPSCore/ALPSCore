...
namespace alps {
    ...
    #define ALPS_NGS_HDF5_BOOST_SHARED_ARRAY_MAKE_PVP(ptr_type, arg_type)                                                                                           \
        template <typename T> detail::make_pvp_proxy<std::pair<ptr_type, std::vector<std::size_t> > > make_pvp(                                                     \
              std::string const & path                                                                                                                              \
            , arg_type value                                                                                                                                        \
            , std::size_t size                                                                                                                                      \
        ) {                                                                                                                                                         \
            return detail::make_pvp_proxy<std::pair<ptr_type, std::vector<std::size_t> > >(                                                                         \
                  path                                                                                                                                              \
        ...
        template <typename T> detail::make_pvp_proxy<std::pair<ptr_type, std::vector<std::size_t> > > make_pvp(                                                     \
            ...
            return detail::make_pvp_proxy<std::pair<ptr_type, std::vector<std::size_t> > >(path, std::make_pair(value.get(), size));                                \
        }
