...
namespace alps {
    namespace hdf5 {
        ...
        #define ALPS_NGS_HDF5_BOOST_NUMERIC_UBLAS_VECTOR_SAVE(ARCHIVE)                                                                                          \
        ...
        ALPS_NGS_HDF5_BOOST_NUMERIC_UBLAS_VECTOR_SAVE(archive)
            ...
            ALPS_NGS_HDF5_BOOST_NUMERIC_UBLAS_VECTOR_SAVE(oarchive)
        #endif
        #undef ALPS_NGS_HDF5_BOOST_NUMERIC_UBLAS_VECTOR_SAVE

        #define ALPS_NGS_HDF5_BOOST_NUMERIC_UBLAS_VECTOR_LOAD(ARCHIVE)                                                                                          \
        ...
        ALPS_NGS_HDF5_BOOST_NUMERIC_UBLAS_VECTOR_LOAD(archive)
        #ifdef ALPS_HDF5_HAVE_DEPRECATED
            ALPS_NGS_HDF5_BOOST_NUMERIC_UBLAS_VECTOR_LOAD(iarchive)
        #endif
        #undef ALPS_NGS_HDF5_BOOST_NUMERIC_UBLAS_VECTOR_LOAD
