...
int main() {
    ...
    {
        lc_type lc = alps::graph::lattice_constant(it->first, lattice, std::vector<boost::graph_traits<graph_type>::vertex_descriptor>(1,side_length*side_length/2+side_length/2));
        if ( lc != it->second)
        {
