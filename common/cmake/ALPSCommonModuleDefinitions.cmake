...
macro(add_boost)
  ...
  # Boost_ROOT is passed as an explicit hint because CMake < 3.12 (no CMP0074)
  # ignores <PackageName>_ROOT.
  find_package(Boost 1.70.0 REQUIRED CONFIG HINTS ${Boost_ROOT} $ENV{Boost_ROOT})
